...
namespace NinetiesTV
{
    class Program
    {
        ...
        // Return all shows ordered by the number of years on air.
        ...
        // Return the names of the comedy shows sorted by IMDB rating.
        ...
        // Return the shows with more than one genre ordered by their starting year.
        ...
        // Return the show with the most episodes.
        ...
        // Order the shows by their ending year then return the first 
        ...
        // Order the shows by rating (highest first) 
        ...
        // Return all dramas except for the highest rated.
        ...
        // Return the number of crime shows with an IMDB rating greater than 7.0.
        static int GoodCrimeShows(List<Show> shows)
        {
            return shows.Where(s => s.Genres.Contains("Crime") && s.ImdbRating > 7).Count();
        }

        // Return the first show that ran for more than 10 years 
        ...
        // Return the show with the most words in the name.
        ...
        // Return the names of all shows as a single string seperated 
        ...
        // Do the same as above, but put the word "and" between the second-to-last and last show name.
        ...
        /***************************************************************************/
        // challenges - don't provide functions for these
        /***************************************************************************/

        // Return the genres of the shows that started in the 80s.
        // Print a unique list of geners.
        // Print the years 1987 - 2018 along with the number of shows that started in each year (note many years will have zero shows)
        // Assume each episode of a comedy is 22 minutes long and each episode of a show that isn't a comedy is 42 minutes. How long would it take to watch every episode of each show?
        // Assume each show ran each year between its start and end years (which isn't true), which year had the highest average IMDB rating.
